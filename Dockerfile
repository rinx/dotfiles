...
ARG CLOJURE_LSP_VERSION=2023.10.30-16.25.41
ARG RUST_ANALYZER_VERSION=2023-11-06
...
COPY --from=packer /out/rust/fennel-language-server /usr/local/bin/fennel-language-server
