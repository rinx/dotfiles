...
trouble.setup({auto_open = true, auto_close = true, signs = {error = icontab.bug, warning = icontab["exclam-circle"], hint = icontab.leaf, information = icontab["info-circle"], other = icontab["comment-alt"]}, action_keys = {switch_severity = "S"}})
