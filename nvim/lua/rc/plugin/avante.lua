...
mcphub.setup({config = vim.fn.expand("~/.nix-profile/config/mcp-servers.json"), extensions = {avante = {enabled = true, make_slash_commands = true}}, native_servers = {["org-mode"] = orgmode_server, ["org-roam"] = orgroam_server}, auto_approve = false})
local toggle
local function _22_()
