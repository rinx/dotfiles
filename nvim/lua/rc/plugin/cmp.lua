...
cmp.setup({enabled = _1_, keymap = {preset = "enter"}, sources = {default = {"lsp", "path", "snippets", "buffer", "ripgrep", "emoji", "git"}, per_filetype = {"orgmode"}, providers = {ripgrep = {module = "blink-ripgrep", name = "Ripgrep"}, emoji = {module = "blink-emoji", name = "Emoji", score_offset = 15, opts = {insert = true}, should_show_items = _2_}, git = {module = "blink-cmp-git", name = "Git", enabled = _3_}, orgmode = {name = "orgmode", module = "orgmode.org.autocompletion.blink", fallbacks = {"buffer"}}}}, completion = {documentation = {auto_show = true, auto_show_delay_ms = 500}, menu = {auto_show = _4_}, list = {selection = {preselect = _5_, auto_insert = _6_}}}, cmdline = {keymap = {["<C-n>"] = {"select_next", "fallback"}, ["<C-p>"] = {"select_prev", "fallback"}, ["<CR>"] = {"accept", "fallback"}}}, snippets = {preset = "mini_snippets"}})
