...
local default_sources = {{name = "nvim_lsp"}, {name = "buffer"}, {name = "treesitter"}, {name = "path"}, {name = "skkeleton"}, {name = "spell"}, {name = "calc"}, {name = "emoji"}}
