...
orgmode.setup({org_agenda_files = {inbox, __3epath("journal/*.org")}, org_default_notes_file = inbox, org_archive_location = __3epath("archive/%s_archive::"), org_todo_keywords = {"TODO", "WAITING", "IN_REVIEW", "|", "CANCELED", "DONE"}, org_startup_folded = "overview", org_capture_templates = {t = {description = "Add a new task to inbox", template = __3etmplstr("task.org"), headline = "Tasks"}, n = {description = "Add a new note to inbox", subtemplates = {c = {description = "code-reading note", template = __3etmplstr("code-note.org"), headline = "Notes"}, d = {description = "default note", template = __3etmplstr("note.org"), headline = "Notes"}, l = {description = "with link", template = __3etmplstr("link.org"), headline = "Notes"}, p = {description = "with clipboard content", template = __3etmplstr("paste.org"), headline = "Notes"}}}, j = {description = "Add a new note to journal", template = __3etmplstr("journal.org"), target = __3epath("journal/%<%Y-%m>.org"), datetree = {tree_type = "day"}}}, org_tags_column = 90, org_custom_exports = {g = {label = "Export to GitHub flavored markdown", action = _4_}}, win_split_mode = "auto", ui = {menu = {handler = _5_}}})
