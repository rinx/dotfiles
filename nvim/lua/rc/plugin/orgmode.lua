...
roam.setup({directory = __3epath("roam"), org_files = {inbox, __3epath("journal/*.org")}, templates = {f = {description = "fleeting", subtemplates = {d = {description = "default", template = __3etmplstr("roam/default.org"), target = "fleeting/%<%Y%m%d%H%M%S>-%[slug].org"}, l = {description = "local note (ignored by git)", template = __3etmplstr("roam/default.org"), target = "fleeting/%<%Y%m%d%H%M%S>-%[slug].local.org"}}}, w = {description = "wiki", subtemplates = {d = {description = "default", template = __3etmplstr("roam/wiki.org"), target = "wiki/%<%Y%m%d%H%M%S>-%[slug].org"}, l = {description = "local note (ignored by git)", template = __3etmplstr("roam/wiki.org"), target = "wiki/%<%Y%m%d%H%M%S>-%[slug].local.org"}}}, p = {description = "project", subtemplates = {d = {description = "default", template = __3etmplstr("roam/project.org"), target = "project/%<%Y%m%d%H%M%S>-%[slug].org"}, l = {description = "local note (ignored by git)", template = __3etmplstr("roam/project.org"), target = "project/%<%Y%m%d%H%M%S>-%[slug].local.org"}}}, c = {description = "code", subtemplates = {d = {description = "default", template = __3etmplstr("roam/code.org"), target = "code/%<%Y%m%d%H%M%S>-%[slug].org"}, l = {description = "local note (ignored by git)", template = __3etmplstr("roam/code.org"), target = "code/%<%Y%m%d%H%M%S>-%[slug].local.org"}}}, b = {description = "book", subtemplates = {d = {description = "default", template = __3etmplstr("roam/book.org"), target = "book/%<%Y%m%d%H%M%S>-%[slug].org"}, l = {description = "local note (ignored by git)", template = __3etmplstr("roam/book.org"), target = "book/%<%Y%m%d%H%M%S>-%[slug].local.org"}}}, s = {description = "scrap", subtemplates = {d = {description = "default", template = __3etmplstr("roam/scrap.org"), target = "scrap/%<%Y%m%d%H%M%S>-%[slug].org"}, l = {description = "local note (ignored by git)", template = __3etmplstr("roam/scrap.org"), target = "scrap/%<%Y%m%d%H%M%S>-%[slug].local.org"}}}}})
