...
roam.setup({directory = __3epath("roam"), org_files = {inbox, __3epath("journal/*.org")}, templates = {d = {description = "default", template = __3etmplstr("roam/default.org"), target = "%<%Y%m%d%H%M%S>-%[slug].org"}}})
