...
vim.keymap.set("n", ",bd", ":<C-u>lua Snacks.bufdelete()<CR>", {silent = true, desc = "delete current buffer"})
vim.keymap.set("n", ",bD", ":<C-u>lua Snacks.bufdelete.other()<CR>", {silent = true, desc = "delete all buffers except for current one"})
...
local custom_actions = {"lua Snacks.git.blame_line()", "lua Snacks.gitbrowse()", "lua Snacks.lazygit()", "lua Snacks.notifier.hide()", "lua Snacks.notifier.show_history()", "lua Snacks.picker.gh_issue()", "lua Snacks.picker.gh_issue({ state = \"all\" })", "lua Snacks.picker.gh_pr()", "lua Snacks.picker.gh_pr({ state = \"all\" })", "lua Snacks.picker.notifications()", "lua Snacks.terminal.toggle()", "lua Snacks.terminal.open()", "AvanteAsk", "AvanteChat", "AvanteToggle", "ConjureConnect", "ConjureLogSplit", "ConjureLogVSplit", "ConjureCljDebugInit", "DapContinue", "DapListBreakpoints", "DapStepInto", "DapStepOut", "DapStepOver", "DapToggleBreakpoint", "DapViewToggle", "Ghq", "Inspect", "InspectTree", "Lazy", "Lazy check", "Lazy update", "Lazy profile", "LspInfo", "LspRestart", "LspStart", "LspStop", "MCPHub", "OrgFind", "OrgGrep", "OrgKensaku", "OrgInbox", "OrgJournal", "OrgRefileToToday", "OrgSearchHeadlines", "PasteImage", "RoamCommitPush", "RoamGrep", "RoamKensaku", "RoamPull", "RoamRefreshSearchIndex", "RoamReset", "RoamStatus", "RoamSearchByTag book", "RoamSearchByTag code", "RoamSearchByTag fleeting", "RoamSearchByTag local", "RoamSearchByTag project", "RoamSearchByTag scrap", "RoamSearchByTag wiki", "Telescope dap list_breakpoints", "Telescope repo list", "Telescope orgmode refile_heading", "Telescope orgmode search_headings", "Telescope orgmode insert_link", "Trouble diagnostics", "Trouble loclist", "Trouble lsp", "Trouble lsp_references", "Trouble quickfix", "Trouble snacks", "Trouble snacks_files", "Trouble todo"}
