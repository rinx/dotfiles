...
snacks.setup({bigfile = {enabled = true}, image = {enabled = true}, input = {}, notifier = {enabled = true}, quickfile = {enabled = true}, terminal = {win = {style = {bo = {filetype = "snacks_terminal"}, wo = {}, keys = {gf = _1_, term_normal = {"<esc>", _4_, mode = "t", expr = true, desc = "escape to normal mode"}}}}}})
