...
local languages = {"bash", "c", "clojure", "cmake", "comment", "commonlisp", "cpp", "css", "cue", "diff", "dockerfile", "dot", "earthfile", "editorconfig", "elixir", "elm", "erlang", "fennel", "fortran", "git_config", "git_rebase", "gitattributes", "gitcommit", "gitignore", "gleam", "go", "gomod", "gosum", "gotmpl", "gowork", "gpg", "graphql", "hcl", "helm", "hjson", "html", "http", "hyprlang", "ini", "janet_simple", "java", "javascript", "jq", "jsdoc", "json", "json5", "jsonnet", "julia", "kotlin", "latex", "llvm", "lua", "luadoc", "luap", "make", "markdown", "markdown_inline", "mermaid", "nginx", "nix", "passwd", "pem", "promql", "proto", "python", "ql", "query", "r", "regex", "rego", "rst", "rust", "scss", "smithy", "sparql", "sql", "ssh_config", "strace", "teal", "terraform", "toml", "tsx", "typescript", "typst", "vim", "vimdoc", "vrl", "vue", "xml", "yaml", "zig"}
ts.setup({})
if not (vim.env.NVIM_DISABLE_TS_PARSER_INSTALL == "1") then
...
do
  ...
  vim.api.nvim_create_autocmd({"FileType"}, {callback = _2_, group = group_5_auto})
end
